...
This folder defines all source code for the 'Games Social Listening Demo Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_games_social_listening_demo_pipeline.py" to get familiar with the syntax.
